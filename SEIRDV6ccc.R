SEIRD5V <- function( S0, E0, I0, RE0, RI0, D0,
 ...
 # rho1Iv <- X1rI*rho1I
  #zeta21v <- X1z2%*%zeta21
  gamma1v <- X1g%*%gamma1
  Out1a <- SEIRDV5cpp(S0, E0, I0, RE0, RI0, D0,  
...
LikeSEIRD5V2 <- function( data1,  S0, E0, I0, RE0, RI0, D0, 
                          alpha1, beta1, betaI1, gamma1, 
                          zeta1, n1,
                          mchpt1 ){
  # Call the solver
  Out1 <- SEIRD5V(  S0, E0, I0, RE0, RI0, D0, 
                    alpha1, beta1, betaI1, gamma1, 
                    zeta1, n1,
                    mchpt1 )
  ...
  res1 <- Lik1AI + Lik1IR + Lik1D 
  return( res1 )
}



PostSEIRD5V1 <- function( data1, S0, E0, I0, RE0, RI0, D0, 
                          alpha1, beta1, betaI1, gamma1, 
                          zeta1, n1,
                          mchpt1,
  ...
  if( min( alpha1F)  > 0 & 
    ...
    Lik1 <- LikeSEIRD5V2( data1, S0, E0, I0, RE0, RI0, D0, 
                          alpha1, beta1, betaI1, gamma1, 
                          zeta1, n1,
                          mchpt1 )
    res1 <- Post1 + Lik1
...
MCMCSEIRD5VPred <- function( data1, S0, E0, I0, RE0, RI0, D0,  
 ...
 # X1r <- MatrixBuild1( rchpt1, n1 )
  ...
  Post1 <- PostSEIRD5V1( data1,  S0, E0, I0, RE0, RI0, D0, 
                         alpha1, beta1, betaI1, gamma1, 
                         zeta1, n1,
                         mchpt1,
                         prior1am, prior1b, prior1g, prior1z )
 ...
 # rho1IOut <- rep( 0, nsamp1 )
  ...
  for( i in 1:nsamp1 ){
    for( j in 1:length( alpha1 ) ){
      ...
      if( alpha1t[j] > 0 ){
        Post1t <- PostSEIRD5V1( data1, S0, E0, I0, RE0, RI0, D0, 
...
# PostPred3 <- function( MCMCPar1, S0Q, E0Q, I0Q, R0Q, D0Q, V0Q, n1Q, chpt1, ImpI1 ){
...
#     Fit1Q <- SEIRD3( S0Q, E0Q, I0Q, R0Q, D0Q, V0Q,
#                      alpha1,
#                      beta1, gamma1, eta1, rho1, kappa1, n1Q,
#                      chpt1,
#                      betaI1, ImpI1 )
...
# SEIRD4V <- function( S0, E0, I0, RE0, RI0, D0, 
...
# 
# SEIRD1 <- function( S0, E0, I0, RE0, RI0, D0, 
