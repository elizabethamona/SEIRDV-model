...
List SEIRDV5cpp( double S0, double E0, double I0, double RE0, 
                 double RI0, double D0, NumericVector alpha1v,
                 double beta1, NumericVector beta1v,
                 NumericVector gamma1v, double zeta1, int n1 ) {
  ...
  for( int i = 0; i < n1; i++ ){
    ...
    D0n = D0;
   // V0n = V0;
    S0 = std::max(0.0, S0n - alpha1v[i]*S0n*E0n );
    E0 = std::max(0.0, E0n + alpha1v[i]*S0n*E0n - beta1*E0n - gamma1v[i]*E0n  - beta1v[i]*E0n );
    I0 = std::max(0.0, I0n + beta1*E0n - gamma1v[i]*I0n - zeta1*I0n + beta1v[i]*E0n );
    RE0 = std::max(0.0, RE0n + gamma1v[i]*E0n );
    ...
    Rep0 =  alpha1v[i]*S0n/(beta1 + gamma1v[i] ) ;
